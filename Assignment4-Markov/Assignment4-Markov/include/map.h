/*
 * File: map.h
 * Last modified on Tue Apr 29 07:37:28 2014 by eroberts
 *      modified on Tue Jun 11 08:14:10 2013 by htiek
 * --------------------------------------------------
 ...
 * --------------------
 * Aug 10 2015 by cpw - removed #include "foreach.h"
...
/* Initializer support */
   Map(std::initializer_list<std::pair<KeyType, ValueType>> lst);
...
template <typename KeyType, typename ValueType>
Map<KeyType,ValueType>::Map(std::initializer_list<std::pair<KeyType, ValueType>> lst) : Map() {
   for (auto p: lst) {
