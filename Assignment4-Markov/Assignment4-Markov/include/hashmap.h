...
/* Initializer list support */
   HashMap(std::initializer_list<std::pair<KeyType, ValueType>> lst);
...
template <typename KeyType, typename ValueType>
HashMap<KeyType,ValueType>::HashMap(std::initializer_list<std::pair<KeyType, ValueType>> lst) : HashMap() {
   for (auto p: lst) {
